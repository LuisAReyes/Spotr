 ...
 * @author: Vlad Kopman
 * 
 *          This file connects to service.php on the webserver to push and
 *          retrieve data from the database
 * 
 *          TODO - HTTP post and responses need to be refactored out of each
 *          method
 */
...
public class DBHelper {
	...
	// returns challenges for the spot, or all local challenges if spot_id is
	// null

	public void setMessage() {
	}

	// adds a message to a spot, can be extended later to work messaging, walls,
	// etc
